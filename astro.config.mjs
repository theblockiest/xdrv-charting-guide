			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Background Events', slug: 'modding/bg-events' },
						{ label: 'Visualizing Background Events', slug: 'modding/bg-visuals'},
						{ label: 'Mods', slug: 'modding/mods' },
						{ label: 'Principles of Modding', slug: 'modding/principles'},

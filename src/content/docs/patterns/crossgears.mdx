...
<div style = "width:100%"> ![Diagram showing the most common arrangement of XDRV.](/src/assets/graphics/xdrv_controller.png) </div> 
...
| <div style = "width:150px"> ![](/src/assets/patterns/left_crossgear.png) </div> | <div style = "width:150px"> ![](/src/assets/patterns/right_crossgear.png) </div> |
| :---: | :---: |
...
<div style = "width:30%"> ![An XDRV pattern that is incompatible with controller.](/src/assets/patterns/controller_incompatible.png) </div> 
...
| <div style = "width:150px"> ![](/src/assets/patterns/tap_crossgears.png) </div> | <div style = "width:150px"> ![](/src/assets/patterns/hold_crossgears.png) </div> |
| :---: | :---: |
...
<div style = "width:30%"> ![An XDRV composed of a crossgear and additional holds.](/src/assets/patterns/crossgear_more_notes.png) </div> 

<Aside type="tip" title="Placing Additional Notes">

Which side the additional notes are placed in relation to the crossgear can change how the chord feels. Additional notes placed on the opposite side of a crossgear make the pattern feel wider. These combos are harder to hit on a controller, as they require the player to stretch their thumb over without moving their middle and index fingers. On the other hand, additional notes placed on the same side of a crossgear make the pattern feel more cramped. These combos are harder to hit on a keyboard, requiring better finger independence.
...
<div style = "width:30%"> ![An XDRV composed of a alternating crossgears and non-crossgear gears.](/src/assets/patterns/crossgear_alternating.png) </div> 

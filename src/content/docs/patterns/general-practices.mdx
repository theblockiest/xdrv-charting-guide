...
| <div style = "width:150px"> ![](/src/assets/patterns/separate.png) </div> | <div style = "width:150px"> ![](/src/assets/patterns/continuous.png) </div> |
| :---: | :---: |
| Separate | Continuous |
...
| <div style = "width:150px"> ![](/src/assets/patterns/unbalanced.png) </div> | <div style = "width:150px"> ![](/src/assets/patterns/balanced.png) </div> |
| :---: | :---: |
| Unbalanced | Balanced |
...
<div style = "width:30%"> ![An XDRV pattern that only uses the middle 4 lanes.](/src/assets/patterns/limited_lanes.png) </div> 

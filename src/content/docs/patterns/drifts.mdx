...
| <div style = "width:150px"> ![](/src/assets/patterns/left_drift.png) </div> | <div style = "width:150px"> ![](/src/assets/patterns/right_drift.png) </div> |
| :---: | :---: |
...
<div style = "width:30%"> ![A dense XDRV pattern with a drift underneath.](/src/assets/patterns/drift_clutter.png) </div> 
...
| <div style = "width:150px"> ![](/src/assets/patterns/left_drift_obscured.png) </div> | <div style = "width:150px"> ![](/src/assets/patterns/right_drift_obscured.png) </div> |
| :---: | :---: |
...
<div style = "width:30%"> ![A drift pattern that goes from left to right without using a drift end.](/src/assets/patterns/drift_malformed.png) </div> 

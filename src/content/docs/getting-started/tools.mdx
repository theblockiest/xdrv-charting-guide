...
1. Go to the [Audacity](https://www.audacityteam.org/) website and download its most recent release, preferably without Muse Hub.
    ...
    ![Audacity download banner](/src/assets/screenshots/audacity_website.png)

2. Run and progress through the Audacity Wizard.

    <div style="width:65%">
    ![Audacity download wizard](/src/assets/screenshots/audacity_wizard.png)
    </div>
</Steps>
...
1. Go to the [Notepad++](https://notepad-plus-plus.org/) website and navigate to the “Download” tab.
    ...
    ![Notepad++ download web page](/src/assets/screenshots/notepad_website.png)
...
3. Run and progress through the Notepad++ Setup.
    ...
    <div style="width:65%">
    ![Notepad++ download wizard](/src/assets/screenshots/notepad_wizard.png)
    </div>
...
2. Find the most recent release of Trackmaker and open the “Assets” dropdown. You should now see a list of files.
    ...
    <div style="width:90%">
    ![Trackmaker release from Github page](/src/assets/screenshots/trackmaker_release.png)
    </div>
...
On Windows, you can extract a .zip file by right-clicking it and selecting “Extract all…”
    ...
    <div style="width:65%">
    ![Trackmaker Extract Compressed window](/src/assets/screenshots/trackmaker_extract.png)
    </div>
...
1. Go to the [XDRVTools](https://github.com/theblockiest/XDRVTools) Github page and select the text that says “Releases.”
    ...
    ![XDRVTools release from Github page](/src/assets/screenshots/xdrvtools_release.png)
...
5. Open up Notepad++. Under “Plugins,” select “Open Plugins Folder…”
    ...
    ![Notepad++ with Plugins dropdown open](/src/assets/screenshots/xdrvtools_dropdown.png)

...
<div style="width:80%">
![Trackmaker window with a blank "Keep Going!" chart open](/src/assets/screenshots/trackmaker/blank.png)
</div>
...
![Trackmaker window displaying a placed checkpoint, a checkpoint ghost, and the checkpoint creation popup](/src/assets/screenshots/trackmaker/checkpoint.png)
...
<div style="width:80%">
![Trackmaker window open to Preview Mode](/src/assets/screenshots/trackmaker/preview.png)
</div>
...
<div style="width:80%">
![Trackmaker window displaying a simple pattern of 8th notes](/src/assets/screenshots/trackmaker/notes.png)
</div>
...
| <div style = "width:150px"> ![](/src/assets/screenshots/trackmaker/selection.png) </div> | <Icon name="right-arrow" size="50px"/> | <div style = "width:150px"> ![](/src/assets/screenshots/trackmaker/selected.png) </div> |
| :---: | :---: | :---: |
| Selecting |  | Selected |
...
| <div style = "width:150px"> ![](/src/assets/screenshots/trackmaker/mirror/original.png) </div> | <div style = "width:150px"> ![](/src/assets/screenshots/trackmaker/mirror/horizontal.png) </div> | <div style = "width:150px"> ![](/src/assets/screenshots/trackmaker/mirror/vertical.png) </div> | <div style = "width:150px"> ![](/src/assets/screenshots/trackmaker/mirror/both.png) </div> |
| :---: | :---: | :---: | :---: |

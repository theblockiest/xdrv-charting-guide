...
3. In the field that says **MODFILE_PATH**, fill in the name of the `.lua` file.
	...
	```
	MUSIC_TITLE=Keep Going!
	MUSIC_ARTIST=Nota
	...
	MODFILE_PATH=HYPER_mods.lua
	...
	--
	```
...
<div style="width:75%">
![Notepad++ window with modfile of "Keep Going!" HYPER open](../../../assets/screenshots/notepad_plusplus.png)
</div>
...
<div style="width:75%">
![Visual Studio Code window with modfile of "Keep Going!" HYPER open](../../../assets/screenshots/visual_studio_code.png)
</div>

</Card>

<Aside type="caution" title="Debugger Warnings">

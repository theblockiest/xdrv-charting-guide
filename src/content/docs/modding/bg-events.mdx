...
### Method 2: `.lua` Events <Badge text="Recommended" variant="success"/>
...
import exampleLua from '../../../assets/charts/Events Example/HYPER_mods.lua?raw'

<Code code={exampleLua} lang="lua" title = {"mods.lua"}/>

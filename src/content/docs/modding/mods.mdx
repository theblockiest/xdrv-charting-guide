...
<Aside type="tip" title="Easing Defaults">
	...
	In EX-XDRiVER, if the ease field is omitted from an ease function call, the easing function of the mod will default to "InOutSine". While this can be convenient, it is typically better to be explicit with your easing functions, as this allows for better readability and easier changes later.

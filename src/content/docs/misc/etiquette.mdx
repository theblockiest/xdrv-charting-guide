...
If you want to receive feedback on a chart that you share via the community Discord forum, make sure to put the “Feedback Requested” tag on it. However, it is totally fine to post a chart without this tag and not recieve feedback.
...
- The original chart is old and no longer reflective of current XDRV charting standards.
	- This can include charts that do not recieve a leaderboard.
